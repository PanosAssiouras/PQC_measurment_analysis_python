...
for file_name in file_names:
    ...
    if (pos!=-1):
        ...
        if label_contents[-1]=="s":
            ...
            resistivity=correction_factor*(2*math.pi*s/(2-math.sqrt(2)))*slope
            print(resistivity)
...
######## Write results to VDPBulk.csv ####################################
        ...
        with open('VDPBulk.csv', newline='', mode='a') as csv_file:
            fieldnames = ['Name', 'R_sh [Ohm/square]', 'delta_Rsh [Ohm/square]','resistivity [Ohm*cm]']
